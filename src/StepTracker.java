...
public class StepTracker {
    ...
    void addNewNumberStepsPerDay(Scanner scanner) {
        ...
        if(moth < 0 && moth > 12 && moth != 12){System.out.println("Вы ввели неправильное число месяца"); return;}

        System.out.println("Введите день месяца от 1 до 30");
        int day = scanner.nextInt();
        if(day < 0 && day > 30 && day != 30){System.out.println("Вы ввели неправильное число дня"); return;}
    ...
    void printStatistic(Scanner scanner){
        ...
        monthData.maxSteps();                 // вывод максимального пройденного количества шагов за месяц
        ...
        System.out.println("Пройденная дистанция в километрах : " + converter.convertToKm(monthData.sumStepsFromMonth())); //пройденная дистанция (в км);
